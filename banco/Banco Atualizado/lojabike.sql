...
--
-- Host: 127.0.0.1
-- Generation Time: 30-Nov-2016 às 01:15
...
(1, '25', 1, 'azul', '25', 'Speed Bike', 'Bhc1414', 4359.03, 'Hidraulica', 1),
(2, '26', 1, 'black', '42', 'Montain Bike', 'rt4645', 5439.03, 'mecanica', 4),
(3, '17', 1, 'black', 'NÃ£o Possui', 'BMX', 'h4bd56', 15439.03, 'NÃ£o Possui', 5),
(4, '27', 1, 'verde', '44', 'Urban Bike', 'Bcx4465', 454.99, 'Motriz', 2),
(5, '22', 0, 'branca', 'NÃ£o Possue', 'Montain Bike', '44647', 3907.14, 'mecanica', 3);
...
(3, '42547856325', 'rua 3 casa 2', 'pedro', 'pedro', 'pedro', '3654128569', 0, 1),
...
CREATE TABLE `vendas` (
  ...
  `quant_prod_venda` int(11) NOT NULL,
...
--
ALTER TABLE `funcionario`
  MODIFY `cod_fun` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
