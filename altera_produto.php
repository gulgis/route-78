...
<html>
    ...
    <div class="container">
        <div class="card card-register mx-auto mt-5">
            <div class="card-header">Altera de Produto</div>

			<!--TEM que adicionar o preencimento altomatico dos campos para alteração com os dados atuais-->
            <div class="card-body">
                <form action="utilidades/recebeFormProduto.php" method="POST">
					...
					<div id="actions" class="row">
						<div class="col-md-12">
							<button type="submit" class="btn btn-success">Salvar</button><!--Faz a alteração do produto-->
							<a href="home.html" class="btn btn-danger">Cancelar</a><!--Cancela a alteração do produto, e volta pra pagina HOME-->
						</div>
					</div>
                </form>
            </div>
